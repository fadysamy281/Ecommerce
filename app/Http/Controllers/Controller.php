...
class Controller extends BaseController
{
    ...
    use AuthorizesRequests, DispatchesJobs, ValidatesRequests,FlashMessagesTrait;
    protected $data = null;
    ...
    protected function responseRedirect($route, $message,
        $type = 'info', $error = false, $withOldInputWhenError = false)
    {
